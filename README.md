...
└── components/backend/           ← backend service specs + committed OpenAPI contracts
    ...
    ├── gateway/                  ← DESIGN, ADR
    └── identity-resolution/      ← DESIGN, PRD, 17 ADRs, openapi.json
```
